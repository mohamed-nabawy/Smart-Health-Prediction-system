...
<html>
  ...
  <nav>
   ...
   <li><a href="logout.php">Log Out</a></li>
    ...
    <div   style="position:relative;min-height:1px;padding-left:15px; padding-right:15px; text-align:center;">  
        <?php
			...
			$user_id = $row["user_id"];
			$get_history = shell_exec('F:\Anaconda2\python user_history.py ' . $user_id);
			echo $get_history
		?>
